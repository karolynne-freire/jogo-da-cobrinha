...
function criarCobrinha (){
    for(i = 0; i < snake.length; i++){
        ...
        context.fillRect(snake[i].x, snake[i].y, box, box); //cria a cobrra
    }
}

function drawFood (){
    context.fillStyle = "red";
    context.fillRect(food.x, food.y, box, box); // cria o fruto
}
...
function iniciarJogo(){    
    ...
    snake.unshift(newHead); //adiciona como primeiro quadro da cobra
}
